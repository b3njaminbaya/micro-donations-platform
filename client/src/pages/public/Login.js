...
const Login = () => {
    ...
    return (
        <div className="relative flex items-center justify-center min-h-[calc(100vh-76px)] bg-brand-50 px-4 overflow-hidden">
            ...
            >
                <div className="text-center mb-7">
                    ...
                    <p className="text-ink-500 text-sm mt-1">Log in to continue supporting causes.</p>
                </div>
                ...
                <p className="text-center text-sm text-ink-500 mt-6">
                    ...
                    <Link to="/register" className="text-brand-600 font-semibold hover:underline">Register here</Link>
                </p>
            </motion.div>
        </div>
    );
